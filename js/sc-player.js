    ...
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $player.bind('onTrackDataLoaded.scPlayer', function(event) {
          ...
          $.each(tracks, function(index, track) {
            ...
            $('<li id="titre_li"><a id="titre" href="' + track.permalink_url +'">' + track.title + '</a><span class="sc-track-duration">' + timecode(track.duration) + '</span></li>').data('sc-track', {id:index}).toggleClass('active', active).appendTo($list);
            if ($("#titre").width() >= ($("#titre_li").width())-10) {
              $('#titre').css({'font-size': 18});
            };
